...
test("heads/tails", () => {
  ...
  const a = new Fraction(new Int(1), new Power(new Int(2), new Int(2)));
  const b = new Fraction(new Int(1), new Power(new Int(3), new Int(2)));
  const specimen = Fraction.add(a, b);
  console.log(specimen.simplify(), specimen.simplify().simplify());
});
